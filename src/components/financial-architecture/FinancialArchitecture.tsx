...
const tradeFinanceItems = [
  'IMPORT LC', 'Electronic Receivables', 'BILLS UNDER EXPORT LC',
...
const cashManagementItems = [
  'ELECTRONIC PAYMENTS', 'Electronic Receivables', 'PHYSICAL RECEIVABLES',
    ...
    <div className="min-h-screen max-h-screen  text-white p-6 flex flex-col" ref={targetRef}>
      ...
      `}
          ...
          <div className="bg-[#111] rounded-lg p-4">
            ...
            {/* Common Layer */}
            <div className="bg-[#232228] px-4 py-3 rounded-xl flex items-center justify-between space-x-4 mt-2">
