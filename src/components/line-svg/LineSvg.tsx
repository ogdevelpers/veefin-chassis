    ...
    return (
      <div className="flex flex-col items-center h-full relative">
        ...
        <svg className="flex-grow w-1" viewBox="0 0 1 100" preserveAspectRatio="none">
          <line x1="0.5" y1="4" x2="0.5" y2="87" stroke="#fff" strokeWidth="0.3" />
        </svg>
        ...
        <svg className="flex-grow w-1" viewBox="0 0 1 100" preserveAspectRatio="none">
          <line x1="0.5" y1="13" x2="0.5" y2="94" stroke="#fff" strokeWidth="0.3" />
        </svg>
  ...
  return (
    <div className="flex items-center w-full relative">
      ...
      <svg className="flex-grow h-1" viewBox="0 0 100 1" preserveAspectRatio="none">
        <line x1="2" y1="0.5" x2="99" y2="0.5" stroke="#fff" strokeWidth="0.3" />
      </svg>
      <span className="px-2 text-white text-sm font-semibold whitespace-nowrap uppercase tracking-wider">
        {title}
      </span>
      <svg className="flex-grow h-1" viewBox="0 0 100 1" preserveAspectRatio="none">
        <line x1="0" y1="0.5" x2="98" y2="0.5" stroke="#fff" strokeWidth="0.3" />
      </svg>
